@echo off
REM Build texoverride.asi. Needs Visual Studio Build Tools 2022 with the "Desktop development with
REM C++" workload. Run from a "x64 Native Tools Command Prompt for VS 2022", or let this find vcvars.
